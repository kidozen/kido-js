...
(function(){function b(a){return 10>a?"0"+a:a}function d(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var c=k[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(c,b){var e,n,m,k,p=g,l,h=b[c];h&&("object"===typeof h&&"function"===typeof h.toJSON)&&(h=h.toJSON(c));"function"===typeof j&&(h=j.call(b,c,h));switch(typeof h){case "string":return d(h);case "number":return isFinite(h)?String(h):"null";case "boolean":case "null":return String(h);case "object":if(!h)return"null";
g+=f;l=[];if("[object Array]"===Object.prototype.toString.apply(h)){k=h.length;for(e=0;e<k;e+=1)l[e]=a(e,h)||"null";m=0===l.length?"[]":g?"[\n"+g+l.join(",\n"+g)+"\n"+p+"]":"["+l.join(",")+"]";g=p;return m}if(j&&"object"===typeof j){k=j.length;for(e=0;e<k;e+=1)"string"===typeof j[e]&&(n=j[e],(m=a(n,h))&&l.push(d(n)+(g?": ":":")+m))}else for(n in h)Object.prototype.hasOwnProperty.call(h,n)&&(m=a(n,h))&&l.push(d(n)+(g?": ":":")+m);m=0===l.length?"{}":g?"{\n"+g+l.join(",\n"+g)+"\n"+p+"}":"{"+l.join(",")+
"}";g=p;return m}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+b(this.getUTCMonth()+1)+"-"+b(this.getUTCDate())+"T"+b(this.getUTCHours())+":"+b(this.getUTCMinutes())+":"+b(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var c=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g,f,k={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},j;"function"!==typeof JSON.stringify&&(JSON.stringify=function(c,d,b){var e;f=g="";if("number"===typeof b)for(e=0;e<b;e+=1)f+=" ";else"string"===typeof b&&(f=b);if((j=d)&&"function"!==typeof d&&("object"!==typeof d||"number"!==typeof d.length))throw Error("JSON.stringify");return a("",{"":c})});
"function"!==typeof JSON.parse&&(JSON.parse=function(a,d){function b(a,c){var e,g,f=a[c];if(f&&"object"===typeof f)for(e in f)Object.prototype.hasOwnProperty.call(f,e)&&(g=b(f,e),void 0!==g?f[e]=g:delete f[e]);return d.call(a,c,f)}var e;a=String(a);c.lastIndex=0;c.test(a)&&(a=a.replace(c,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
