...
Kido.prototype.queues=function(){this._queues||(this._queues=new KidoQueues(this));return this._queues};var KidoSecurity=function(d){if(!(this instanceof KidoSecurity))return new KidoSecurity(d);if(!d)throw"The 'kidoApp' argument is required by the KidoSecurity class.";var c=this;this.app=d;this.SERVICE_NAME="security";this.getLoggedInUser=function(){return c.app.get("/user").then(function(a){a.forEach(function(a){a.type.substring(a.type.lastIndexOf("/")+1)})})};this.getOriginalToken=function(){return c.app.get("/user/original-token")};this.getJWT=function(a){return c.app.get("/api/v3/delegation/token"+
