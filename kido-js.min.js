...
(function(){function b(a){return 10>a?"0"+a:a}function d(a){g.lastIndex=0;return g.test(a)?'"'+a.replace(g,function(a){var c=h[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(c,b){var g,h,n,p,q=f,m,j=b[c];j&&("object"===typeof j&&"function"===typeof j.toJSON)&&(j=j.toJSON(c));"function"===typeof l&&(j=l.call(b,c,j));switch(typeof j){case "string":return d(j);case "number":return isFinite(j)?String(j):"null";case "boolean":case "null":return String(j);case "object":if(!j)return"null";
f+=e;m=[];if("[object Array]"===Object.prototype.toString.apply(j)){p=j.length;for(g=0;g<p;g+=1)m[g]=a(g,j)||"null";n=0===m.length?"[]":f?"[\n"+f+m.join(",\n"+f)+"\n"+q+"]":"["+m.join(",")+"]";f=q;return n}if(l&&"object"===typeof l){p=l.length;for(g=0;g<p;g+=1)"string"===typeof l[g]&&(h=l[g],(n=a(h,j))&&m.push(d(h)+(f?": ":":")+n))}else for(h in j)Object.prototype.hasOwnProperty.call(j,h)&&(n=a(h,j))&&m.push(d(h)+(f?": ":":")+n);n=0===m.length?"{}":f?"{\n"+f+m.join(",\n"+f)+"\n"+q+"}":"{"+m.join(",")+
...
return d.app.del("/config/"+a)}};Kido.prototype.config=function(){this._config||(this._config=new KidoConfig(this));return this._config};var KidoEmail=function(b){var d=this;if(!(this instanceof KidoEmail))return new KidoEmail(b);if(!b)throw"The 'kidoApp' argument is required by the KidoEmail class.";this.app=b;this.send=function(a,c,b,f,e,h,l){if(a&&"object"===typeof a){var k=a;a=k.from;c=k.to;b=k.subject;f=k.bodyText;e=k.bodyHtml;h=k.attachments;l=k.timeout}if(!a)throw"The 'from' argument is required to send an email.";if(!c)throw"The 'to' argument is required to send an email.";!h&&e instanceof Array&&(h=e,e=null);k={to:c,from:a};
"string"===typeof b&&0<b.length&&(k.subject=b);"string"===typeof f&&0<f.length&&(k.bodyText=f);"string"===typeof e&&0<e.length&&(k.bodyHtml=e);h instanceof Array&&(k.attachments=h);return d.app.send({url:"/email",type:"POST",data:JSON.stringify(k),timeout:l||9E5})};this.attach=function(a,c,b){a instanceof HTMLFormElement&&(a=new FormData(a));if(a instanceof HTMLInputElement){if(!a.type||"file"!==a.type.toLowerCase())throw"HTML Input element must be of type 'file'.";a=a.files[0]}if(a instanceof File){var d=
a;a=new FormData;a.append(d.name,d)}if(a instanceof FormData)"function"===typeof c&&(b=c,c=null);else if("string"===typeof a){d=a;a=new FormData;if(!c||"function"===typeof c)throw"if a name was specified, 'data' argument is required.";"string"===typeof c&&(c=new Blob([c],{type:"text/text"}));if(!(c instanceof Blob))throw"'data' argument must be a string, a Blob instance or a File instance.";a.append(d,c,d)}else throw"The argument 'formOrName' is invalid.";var e=new jQuery.Deferred;c=function(a){e.reject(a.currentTarget)};
d=new XMLHttpRequest;d.upload&&"function"===typeof b&&d.upload.addEventListener("progress",b,!1);d.addEventListener("load",function(a){e.resolve(JSON.parse(a.currentTarget.response))},!1);d.addEventListener("error",c,!1);d.addEventListener("abort",c,!1);d.open("POST","/email/attachments");d.send(a);return e.promise()}};Kido.prototype.email=function(){this._email||(this._email=new KidoEmail(this));return this._email};var KidoLogging=function(b){var d=this;if(!(this instanceof KidoLogging))return new KidoLogging(b);if(!b)throw"The 'kidoApp' argument is required by the KidoLogging class.";this.app=b;this.writeVerbose=function(a){return d.write(a,0)};this.writeInfo=function(a){return d.write(a,1)};this.writeWarning=function(a){return d.write(a,2)};this.writeError=function(a){return d.write(a,3)};this.writeCritical=function(a){return d.write(a,4)};this.write=function(a,c){if(!a)throw"'data' argument is requiered.";
if(!c&&0!==c)throw"'level' argument is required.";if(!(0<=c&&4>=c))throw"'level' argument must be an integer number between 0 and 4.";return d.app.send({url:"/logging?level="+c,type:"POST",data:JSON.stringify(a)})};this.query=function(a,c){var b=[];a&&b.push("query="+JSON.stringify(a));c&&b.push("options="+JSON.stringify(c));return d.app.send({url:"/logging"+(0<b.length?"?"+b.join("&"):""),type:"GET"})};this.get=function(a,c,b,f){var e={};c&&(e.level=c);if(a){if(!(a instanceof Date))throw"'Since' argument accepts only null or Date values.";
e.dateTime={$gt:a}}else e.dateTime={$exists:!0};a={$sort:{dateTime:-1}};b&&(a.$skip=b);f&&(a.$limit=f);return d.query(e,a)};this.clear=function(){return d.app.send({url:"/logging",type:"DELETE",dataType:"text"})}};Kido.prototype.logging=function(){this._logging||(this._logging=new KidoLogging(this));return this._logging};var KidoNotifications=function(b){if(!(this instanceof KidoNotifications))return new KidoNotifications(b);if(!b)throw"The 'kidoApp' argument is required by the KidoNotifications class.";this.app=b;this.send=function(b,a,c,g,f,e,h){if(!b)throw"'channel' argument is required.";if(!a)throw"'title' argument is required.";a={title:a};"string"===typeof g&&g&&(a.type=g);"string"===typeof c&&c&&(a.text=c);"string"===typeof e&&e&&(a.image=e);"number"===typeof f&&(a.badge=f);h&&(a.param=h);return parentKido.send({url:"/notifications/push/"+
